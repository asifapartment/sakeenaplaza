                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-1">
                    ...
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full bg-neutral-800 border-2 border-neutral-700 hover:border-neutral-600 focus:border-amber-500 rounded-xl pl-12 pr-4 py-3 text-neutral-100 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-amber-500/30 transition-all duration-200"
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="bg-neutral-800 border-2 border-neutral-700 hover:border-neutral-600 focus:border-amber-500 rounded-xl pl-10 pr-8 py-3 text-neutral-100 appearance-none focus:outline-none focus:ring-2 focus:ring-amber-500/30 transition-all duration-200 cursor-pointer"
                        >
                            ...
                            <option value="failed" className="bg-neutral-800">Failed</option>
                            <option value="refunded" className="bg-neutral-800">Refunded</option>
                        </select>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                            <div className="relative">
                                <input
                                    ...
                                    className="bg-neutral-800 border-2 border-neutral-700 hover:border-neutral-600 focus:border-amber-500 rounded-xl px-4 py-2.5 text-neutral-100 focus:outline-none focus:ring-2 focus:ring-amber-500/30 transition-all duration-200 min-w-[140px]"
                                    max={filters.endDate || ''}
                                />
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={onRefresh}
                            disabled={loading}
                            className="group relative bg-neutral-800 hover:bg-neutral-700 text-neutral-100 px-4 py-2.5 rounded-xl flex items-center gap-2 text-sm font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed border-2 border-neutral-700 hover:border-neutral-600"
                        >
                            <div className="relative">
                                <FontAwesomeIcon
                                    icon={faSync}
                        ...
                        {(filters.search || filters.status !== 'all' || filters.startDate || filters.endDate) && (
                            <button
                                ...
                                className="text-sm text-neutral-400 hover:text-neutral-200 px-3 py-2 hover:bg-neutral-800/50 rounded-lg transition-colors"
                ...
                <div className="mt-4 pt-4 border-t border-neutral-800">
                    <div className="flex items-center gap-2 text-sm text-neutral-400">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {filters.search && (
                                <span className="inline-flex items-center gap-1 bg-neutral-800 px-3 py-1 rounded-lg">
