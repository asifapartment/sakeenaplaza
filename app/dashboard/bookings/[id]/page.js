...
export default function BookingDetailPage() {
    ...
    const getStatusInfo = () => {
        if (!booking) return { text: 'text-gray-400', border: 'border-gray-600', bg: 'bg-black', icon: faInfoCircle };
        switch (booking.status) {
            case 'confirmed':
                return { text: 'text-emerald-400', border: 'border-emerald-500/50', bg: 'bg-emerald-500/10', icon: faCheckCircle };
            case 'pending':
            ...
            case 'expired':
                return { text: 'text-gray-400', border: 'border-gray-600', bg: 'bg-gray-800/50', icon: faHourglassHalf };
            default:
                return { text: 'text-gray-400', border: 'border-gray-600', bg: 'bg-black', icon: faInfoCircle };
        }
    };
    ...
    const Skeleton = () => (
        <div className="min-h-screen bg-neutral-950">
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Header Skeleton */}
                <div className="mb-8">
                    <div className="mb-4 inline-flex items-center gap-2 px-4 py-2 bg-gray-800/50 rounded-lg border border-white/10">
                    ...
                    <div className="flex justify-between items-start flex-wrap gap-4">
                        ...
                        <div className="h-8 w-24 bg-gray-800 rounded-full animate-pulse border border-white/10"></div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                        ...
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                            ...
                            <div className="mt-4 p-4 bg-gradient-to-r from-teal-600/10 to-emerald-600/10 rounded-xl border border-teal-500/20">
                        ...
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                            ...
                            <div className="space-y-3">
                                {[1, 2].map(i => (
                                    <div key={i} className="bg-gray-800/30 rounded-xl p-4 border border-white/10">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    <div className="h-3 w-3 bg-gray-800 rounded animate-pulse"></div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-teal-600/10 to-emerald-600/10 backdrop-blur-sm rounded-2xl border border-teal-500/30 p-6">
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-8 h-8 bg-gray-800 rounded-lg animate-pulse"></div>
                                <div className="h-6 w-32 bg-gray-800 rounded animate-pulse"></div>
                            </div>
                        ...
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                            ...
                            <div className="relative w-full h-3 bg-gray-800 rounded-full overflow-hidden">
                                <div className="absolute left-0 top-0 h-full bg-gradient-to-r from-teal-600 to-emerald-600 rounded-full w-1/2 animate-pulse"></div>
                            </div>
    ...
    if (error || !booking) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-black flex items-center justify-center">
                <div className="text-center bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-8 max-w-md">
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-lg hover:from-teal-700 hover:to-emerald-700 transition-all duration-300 shadow-lg"
                    >
                        Back to Dashboard
                    </button>
                </div>
        ...
        <div className="min-h-screen bg-neutral-950">
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <button
                        onClick={() => router.back()}
                        className="mb-4 inline-flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-white transition-colors duration-200 bg-gray-800/50 rounded-lg border border-white/20 hover:border-gray-600"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        {/* Apartment Info Card */}
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:border-white/20 transition-all duration-300">
                            <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="flex items-center gap-2 text-gray-400 text-sm mb-4">
                                <FontAwesomeIcon icon={faLocationDot} className="text-teal-500" />
                            ...
                            <div className="flex flex-wrap gap-4 pt-3 border-t border-white/10">
                                <div className="flex items-center gap-2 text-gray-300 text-sm bg-gray-800/50 px-3 py-1.5 rounded-lg">
                                    <FontAwesomeIcon icon={faUsers} className="text-teal-500" />
                                    <span>Max {booking.max_guests} guests</span>
                                </div>
                                <div className="flex items-center gap-2 text-gray-300 text-sm bg-gray-800/50 px-3 py-1.5 rounded-lg">
                                    <FontAwesomeIcon icon={faMoneyBillWave} className="text-teal-500" />
                        ...
                        {booking.guest_details && booking.guest_details.length > 0 && (
                            <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:border-white/20 transition-all duration-300">
                                <h2 className="text-white font-semibold mb-4 flex items-center gap-2">
                                    ...
                                    Guest Details
                                    <span className="text-gray-500 text-sm ml-2">({booking.guest_details.length} guest{booking.guest_details.length > 1 ? 's' : ''})</span>
                                </h2>
                                <div className="space-y-3">
                                    {booking.guest_details.map((guest, index) => (
                                        <div key={index} className="bg-gray-800/30 rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all duration-300">
                                            <div className="flex items-start gap-3">
                                                <div className="w-12 h-12 bg-gradient-to-br from-teal-600 to-emerald-600 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg">
                                                    {guest.name?.charAt(0)?.toUpperCase() || "G"}
                                                </div>
                                                <div className="flex-1">
                                                    <p className="text-white font-semibold text-lg">{guest.name}</p>
                                                    <div className="flex flex-wrap gap-4 mt-2 text-sm">
                                                        <span className="text-gray-400">Age: <span className="text-white">{guest.age}</span></span>
                                                        <span className="text-gray-400">Gender: <span className="text-white">{guest.gender}</span></span>
                                                    </div>
                    ...
                    <div className="space-y-6">
                        {/* Price Summary Card */}
                        <div className="bg-gradient-to-br from-teal-600/10 to-emerald-600/10 backdrop-blur-sm rounded-2xl border border-teal-500/30 p-6 sticky top-8">
                            <h2 className="text-white font-semibold mb-4 flex items-center gap-2">
                                <div className="w-8 h-8 bg-gradient-to-br from-teal-600 to-emerald-600 rounded-lg flex items-center justify-center">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-300">₹{Number(booking.price_per_night).toLocaleString()} x {booking.nights} nights</span>
                        ...
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:border-white/20 transition-all duration-300">
                            ...
                            <div className={`text-center p-4 rounded-xl ${booking.payment_status === 'paid' ? 'bg-emerald-500/10 border border-emerald-500/30' : 'bg-amber-500/10 border border-amber-500/30'
                                }`}>
                                <div className={`text-xl font-bold flex items-center justify-center gap-2 ${booking.payment_status === 'paid' ? 'text-emerald-400' : 'text-amber-400'
                                    }`}>
                                    <FontAwesomeIcon icon={booking.payment_status === 'paid' ? faCheckCircle : faClock} />
                                    {booking.payment_status?.toUpperCase() || 'UNPAID'}
                                </div>
                                {booking.payment_method && (
                                    <div className="text-gray-400 text-sm mt-2">Via {booking.payment_method}</div>
                                )}
                        ...
                        <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:border-white/20 transition-all duration-300">
                            ...
                            <div className="relative w-full h-3 bg-gray-800 rounded-full overflow-hidden">
                                <div className="absolute left-0 top-0 h-full bg-gradient-to-r from-teal-600 to-emerald-600 rounded-full transition-all duration-500" style={{ width: `${progress}%` }}></div>
                            </div>
                            <div className="flex justify-between items-center mt-2">
                        ...
                        {booking.status !== 'cancelled' && booking.status !== 'expired' && (
                            <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6 hover:border-white/20 transition-all duration-300">
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <div className={`flex items-center gap-1 text-xs px-3 py-1.5 rounded-full ${booking.document_status === 'approved' ? 'text-emerald-400 border border-emerald-500/30 bg-emerald-500/10' :
                                ...
                                {booking.document_status === 'rejected' && (
                                    <div className="mt-3">
                                        <button
                                            ...
                                            className="w-full px-4 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2 shadow-lg disabled:opacity-50"
                                        >
                                ...
                                {(!booking.document_status || booking.document_status === 'pending') && (
                                    <button
                                        onClick={() => setShowVerificationModal(true)}
                                        className="w-full px-4 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white rounded-xl text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2 shadow-lg"
                                    >
                                ...
                                {booking.document_status === 'approved' && (
                                    <div className="flex items-center gap-3 text-emerald-400 bg-emerald-500/10 p-3 rounded-xl justify-center">
                        ...
                        {booking.status !== 'cancelled' && booking.status !== 'expired' && booking.status !== 'completed' && (
                            <button
                                ...
                                className="w-full px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl transition-all duration-300 flex items-center justify-center gap-2 font-medium shadow-lg"
                            >
                        ...
                        {booking.status === 'cancelled' && booking.cancelled_at && (
                            <div className="bg-black backdrop-blur-sm rounded-2xl border border-white/10 p-6 text-center">
                                <FontAwesomeIcon icon={faHourglassHalf} className="text-gray-600 text-3xl mb-3" />
                                <p className="text-gray-500 text-sm">Cancelled on</p>
                                <p className="text-gray-300 font-semibold text-lg">{new Date(booking.cancelled_at).toLocaleDateString()}</p>
                            </div>
                        )}
                    </div>
                </div>
